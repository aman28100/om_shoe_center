                            ...
                            <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
                                ...
                                <div class="accordion-body px-0 pb-0 pt-3">
                                    <ul class="list list-inline mb-0">
                                        ...
                                        <li class="list-item">
                                            <a href="#" class="menu-link py-1">Loafer</a>


                                            Shop
                                        </li>
                                        <li class="list-item">
                                            <a href="#" class="menu-link py-1">Sports</a>
                                        </li>
                                        <li class="list-item">
                                            <a href="#" class="menu-link py-1">Formal</a>
                                        </li>
                                        <li class="list-item">
                                            <a href="#" class="menu-link py-1">Party Wear</a>
                                        </li>
                                        <li class="list-item">
                                            <a href="#" class="menu-link py-1">Sports
                                            </a>
                                        </li>
                                        <li class="list-item">
                                            <a href="#" class="menu-link py-1">Sleeper</a>
                                        </li>
                    ...
                    <div class="accordion-item mb-4 pb-3">
                        ...
                        <div id="accordion-filter-size" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="accordion-body px-0 pb-0">
                                <div class="d-flex flex-wrap">
                                    <a href="#"
                                        class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">2</a>
                                    <a href="#"
                                        class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">3</a>
                                    <a href="#"
                                        class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">4</a>
                                    <a href="#"
                                        class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">5</a>
                                    <a href="#"
                                        class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">6</a>
                                    <a href="#"
                                        class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">7</a>
                                    <a href="#"
                                        class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">8</a>
                                    <a href="#"
                                        class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">9</a>
                                    <a href="#"
                                        class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">10</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <select class="d-none" multiple name="total-numbers-list">
                                    ...
                                    <option value="2">Relaxo</option>
                                    <option value="3">Shreeleather</option>
                                    <option value="4">Red chief</option>
                                ...
                                <ul class="multi-select__list list-unstyled">
                                    ...
                                    <li
                                        class="search-suggestion__item multi-select__item text-primary js-search-select js-multi-select">
                                        <span class="me-auto">Relaxo</span>
                                        <span class="text-secondary">7</span>
                                    </li>
                                    <li
                                        class="search-suggestion__item multi-select__item text-primary js-search-select js-multi-select">
                                        <span class="me-auto">Shreeleather</span>
                                        <span class="text-secondary">10</span>
                                    </li>
                                    <li
                                        class="search-suggestion__item multi-select__item text-primary js-search-select js-multi-select">
                                        <span class="me-auto">Red chief</span>
                                ...
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            ...
                                            Women's <br /><strong>Shoes</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Shoes are the
                                            perfect way to elevate your style. Step up your look with new designs and fresh
                                            colors, or opt for classic silhouettes that never go out of fashion.</h6>
                                    </div>
                                </div>
                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                                            Men's <br /><strong>Shoes</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Shoes are the
                                            perfect way to elevate your style. Step up your look with new designs and fresh
                                            colors, or opt for classic silhouettes that never go out of fashion.</h6>
                                    </div>
                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                                            Children <br /><strong>Shoes</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Shoes are the
                                            perfect way to elevate your style. Step up your look with new designs and fresh
                                            colors, or opt for classic silhouettes that never go out of fashion.</h6>
                                    </div>
